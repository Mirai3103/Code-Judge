        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DifficultyLevel = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    TemplateCode = table.Column<string>(type: "text", unicode: false, nullable: false),
                    Hint = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true),
                    EditorialId = table.Column<int>(type: "int", nullable: true),
                    TimeLimit = table.Column<int>(type: "int", nullable: false),
                    MemoryLimit = table.Column<float>(type: "float", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatedBy = table.Column<string>(type: "longtext", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "longtext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Code = table.Column<string>(type: "text", unicode: false, nullable: false),
                    Language = table.Column<int>(type: "int", nullable: false),
                    Error = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true),
                    ProblemId = table.Column<int>(type: "int", nullable: false),
                    RunTime = table.Column<int>(type: "int", nullable: false),
                    Memory = table.Column<float>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Input = table.Column<string>(type: "text", unicode: false, nullable: false),
                    Output = table.Column<string>(type: "longtext", unicode: false, nullable: false),
                    ProblemId = table.Column<int>(type: "int", nullable: false),
